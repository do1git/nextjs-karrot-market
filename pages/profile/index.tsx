    ...
    <div className="py-10 px-4">
      ...
      <div className="flex justify-center space-x-24 mt-8">
        <div className="group cursor-pointer p-4">
          <div className="bg-orange-500 group-hover:bg-orange-600 flex justify-center items-center w-14 h-14 rounded-full text-white">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <span className="block mt-2 text-gray-900">판매내역</span>
        </div>
        <div className="group cursor-pointer p-4">
          <div className="bg-orange-500 group-hover:bg-orange-600 flex justify-center items-center w-14 h-14 rounded-full text-white">
            <svg
          ...
          <span className="block mt-2 text-gray-900">구매내역</span>
        </div>
        <div className="group cursor-pointer p-4">
          <div className="bg-orange-500 group-hover:bg-orange-600 flex justify-center items-center w-14 h-14 rounded-full text-white">
            <svg
          ...
          <span className="block mt-2 text-gray-900">관심목록</span>
        </div>
      </div>
